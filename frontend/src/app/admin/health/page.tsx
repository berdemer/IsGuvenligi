  ...
  topAlerts: [
    {
      ...
      message: t('alerts.responseTimeExceeded'),
      value: 450,
      threshold: 400,
      unit: 'ms',
    ...
    },
    {
      ...
      message: t('alerts.memoryUsageHigh'),
      value: 78,
      threshold: 75,
      unit: '%',
            ...
            {trend && (
              <div className="flex items-center gap-1 mt-1">
                ...
                <span className={`text-xs ${
                  ...
                  {Math.abs(trend.change)}% {t('fromPeriod')} {trend.period}
                </span>
              </div>
            )}
          </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">
                    {overview.healthyServices} {t('healthy')}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <AlertTriangle className="h-4 w-4 text-yellow-500" />
                  <span className="text-sm">
                    {overview.services.filter(s => s.status === 'warning').length} {t('warning')}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <AlertCircle className="h-4 w-4 text-red-500" />
                  <span className="text-sm">
                    {overview.services.filter(s => s.status === 'critical').length} {t('critical')}
                  </span>
                </div>
              </div>
            </div>
