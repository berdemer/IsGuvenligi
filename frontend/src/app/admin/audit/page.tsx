      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">{t('stats.totalLogs')}</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">{t('stats.errorLogs')}</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">{t('stats.warningLogs')}</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">{t('stats.today')}</p>
            ...
            <div className="flex gap-2">
              <Select value={levelFilter} onValueChange={setLevelFilter}>
                <SelectTrigger className="w-[140px]">
                  <SelectValue placeholder={t('search.level')} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">{t('filters.allLevels')}</SelectItem>
                  <SelectItem value="error">{t('filters.error')}</SelectItem>
                  <SelectItem value="warn">{t('filters.warn')}</SelectItem>
                  <SelectItem value="info">{t('filters.info')}</SelectItem>
                  <SelectItem value="debug">{t('filters.debug')}</SelectItem>
                </SelectContent>
              </Select>
              
              <Select value={resourceFilter} onValueChange={setResourceFilter}>
                <SelectTrigger className="w-[140px]">
                  <SelectValue placeholder={t('search.resource')} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="all">{t('filters.allResources')}</SelectItem>
                  <SelectItem value="auth">{t('filters.auth')}</SelectItem>
                  <SelectItem value="user">{t('filters.user')}</SelectItem>
                  <SelectItem value="role">{t('filters.role')}</SelectItem>
                  <SelectItem value="oauth">{t('filters.oauth')}</SelectItem>
                  <SelectItem value="audit">{t('filters.audit')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      {log.user ? (
                        ...
                        <div className="text-sm text-gray-500">{t('table.systemUnknown')}</div>
                      )}
                    </div>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <div className="max-w-xs">
                      {log.details && Object.keys(log.details).length > 0 ? (
                        ...
                        <span className="text-xs text-gray-500">{t('table.noDetails')}</span>
                      )}
                    </div>
                  </TableCell>
                </TableRow>
