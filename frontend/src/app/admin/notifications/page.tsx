      ...
      recentNotifications: [
        {
          id: 'notif-1',
          type: 'security',
          title: t('page.mockData.multipleLoginFailures'),
          description: t('page.mockData.multipleLoginFailuresDesc', { user: 'john.doe@company.com' }),
          source: 'auth',
          severity: 'high',
          status: 'unread',
          relatedEntity: {
        ...
        },
        {
          id: 'notif-2',
          type: 'system',
          title: t('page.mockData.databaseWarning'),
          description: t('page.mockData.databaseWarningDesc'),
          source: 'system',
          severity: 'medium',
          status: 'unread',
        ...
        },
        {
          id: 'notif-3',
          type: 'risk',
          title: 'Yüksek Risk Skoru Uyarısı',
          description: 'Çalışan Sarah Johnson 78/100 puanla risk eşiğini aştı',
        ...
        },
        {
          id: 'notif-4',
          type: 'user_activity',
          title: t('page.mockData.newAdminUser'),
          description: t('page.mockData.newAdminUserDesc', { user: 'Mike Chen' }),
        ...
        },
        {
          id: 'notif-5',
          type: 'system',
          title: 'Keycloak Entegrasyonu Sağlıklı',
          description: 'Keycloak sunucusuna bağlantı başarıyla yenilendi',
          source: 'keycloak',
          severity: 'low',
          status: 'read',
  ...
  const generateMockNotifications = useCallback((): Notification[] => {
    const baseNotifications = [
      // Security notifications
      {
        ...
        title: 'Şüpheli Giriş Aktivitesi',
        description: 'Alışılmadık konumdan giriş denemesi: Tokyo, Japonya',
      ...
      },
      {
        id: 'sec-2',
        type: 'security' as NotificationType,
        title: 'Çok Faktörlü Kimlik Doğrulama Atlama Girişimi',
        description: 'Kullanıcı çok faktörlü kimlik doğrulamayı atlamaya çalıştı',
        source: 'auth' as const,
      ...
      },
      {
        ...
        description: 'Kullanıcı oturumu politika ihlali nedeniyle sonlandırıldı',
      ...
      // System notifications
      {
        ...
        title: 'Yüksek API Gecikmesi Tespit Edildi',
        description: 'Kimlik doğrulama API yanıt süresi 2.3 saniyeye yükseldi',
      ...
      },
      {
        id: 'sys-2',
        type: 'system' as NotificationType,
        title: t('page.mockData.backupCompleted'),
        description: t('page.mockData.backupCompletedDesc'),
        source: 'system' as const,
      ...
      // Risk & Safety notifications
      {
        ...
        title: t('page.mockData.safetyIncident'),
        description: t('page.mockData.safetyIncidentDesc'),
      ...
      },
      {
        id: 'risk-2',
        type: 'risk' as NotificationType,
        title: 'Risk Eşiği Aşıldı',
        description: 'Departman güvenlik skoru kabul edilebilir eşiğin altına düştü',
      ...
      // User Activity notifications
      {
        ...
        title: 'Rol Ataması Değiştirildi',
        description: 'Kullanıcı Emma Davis Güvenlik Müdürü rolüne terfi ettirildi',
      ...
      },
      {
        ...
        description: 'Kullanıcı David Brown şifresini başarıyla sıfırladı',
        source: 'auth' as const,
        severity: 'low' as const,
        status: 'read' as const,
    ...
    const additionalNotifications = Array.from({ length: 100 }, (_, i) => ({
      ...
      description: `Bu test amaçlı bir bildirimdir #${i + 1}`,
