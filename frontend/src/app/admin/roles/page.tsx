    ...
    const mockRoles: Role[] = [
      {
        id: '1',
        name: 'admin',
        displayName: t('mockData.admin.displayName'),
        description: t('mockData.admin.description'),
        permissions: [
      ...
      },
      {
        id: '2',
        name: 'manager',
        displayName: t('mockData.manager.displayName'),
        description: t('mockData.manager.description'),
        permissions: [
      ...
      },
      {
        id: '3',
        name: 'viewer',
        displayName: t('mockData.viewer.displayName'),
        description: t('mockData.viewer.description'),
        permissions: [
          'user:read',
          'role:read',
          'audit:read',
