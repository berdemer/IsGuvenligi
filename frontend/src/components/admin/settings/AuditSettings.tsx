...
export default function AuditSettings({ onSettingsChange }: AuditSettingsProps) {
  const t = useTranslations('settings.auditSettings')
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label>{t('general.enableLabel')}</Label>
              <p className="text-sm text-muted-foreground">
                {t('general.enableDescription')}
              </p>
            </div>
            <Switch
          ...
          {config.general.enabled && (
            <>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="WARN">{t('general.logLevels.warning')}</option>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="retentionDays">{t('general.retentionDays')}</Label>
                    <Input
                      id="retentionDays"
                      type="number"
                      min="30"
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      <Label>{t('events.authEvents')}</Label>
                      <Switch
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <Label>{t('events.configChanges')}</Label>
                      <Switch
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="location">{t('storage.location')}</Label>
                    <select
                      id="location"
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full p-2 border rounded-md"
                    >
                      <option value="hourly">{t('storage.rotationPolicies.hourly')}</option>
                      <option value="daily">{t('storage.rotationPolicies.daily')}</option>
                      <option value="weekly">{t('storage.rotationPolicies.weekly')}</option>
                      <option value="monthly">{t('storage.rotationPolicies.monthly')}</option>
                    </select>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <Label>{t('alerts.failedLogins')}</Label>
                      <Switch
