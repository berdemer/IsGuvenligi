...
{t('conflictManager.title')}
              </CardTitle>
              <CardDescription>
{t('conflictManager.description')}
              </CardDescription>
            </CardHeader>
          </Card>
            ...
            <CardContent className="pt-4">
              <div className="flex flex-wrap gap-4">
                <div className="flex-1 min-w-[200px]">
                  <Input
placeholder={t('conflictManager.searchPlaceholder')}
                    value={searchTerm}
...
<SelectValue placeholder={t('conflictManager.filters.severity')} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">{t('conflictManager.filters.allSeverity')}</SelectItem>
                    <SelectItem value="critical">{t('conflictManager.severity.critical')}</SelectItem>
                    <SelectItem value="high">{t('conflictManager.severity.high')}</SelectItem>
                    <SelectItem value="medium">{t('conflictManager.severity.medium')}</SelectItem>
                    <SelectItem value="low">{t('conflictManager.severity.low')}</SelectItem>
                  </SelectContent>
                </Select>
                <Select value={typeFilter} onValueChange={setTypeFilter}>
                  <SelectTrigger className="w-[130px] h-9">
<SelectValue placeholder={t('conflictManager.filters.type')} />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">{t('conflictManager.filters.allTypes')}</SelectItem>
                    <SelectItem value="contradiction">{t('conflictManager.types.contradiction')}</SelectItem>
                    <SelectItem value="priority">{t('conflictManager.types.priority')}</SelectItem>
                    <SelectItem value="overlap">{t('conflictManager.types.overlap')}</SelectItem>
                    <SelectItem value="circular">{t('conflictManager.types.circular')}</SelectItem>
                  </SelectContent>
                </Select>
...
{t('conflictManager.priorityOrder.title')}
              </CardTitle>
              <CardDescription>
{t('conflictManager.priorityOrder.description')}
              </CardDescription>
            </CardHeader>
          </Card>
