...
export default function PolicyAnalytics() {
  ...
  const t = useTranslations('policies.policyAnalytics')
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard
          title={t('metrics.totalAttempts.title')}
          value={analytics.accessAttempts.total.toLocaleString()}
          change={12}
          trend="up"
          icon={<Activity className="h-4 w-4 text-muted-foreground" />}
          description={t('metrics.totalAttempts.description')}
        />
        <MetricCard
          title={t('metrics.successRate.title')}
          value={`${successRate}%`}
          change={-2.3}
          trend="down"
        ...
        />
        <MetricCard
          title={t('metrics.activePolicies.title')}
          value={analytics.activePolicies}
          change={5}
          trend="up"
          icon={<Users className="h-4 w-4 text-muted-foreground" />}
          description={`${analytics.totalPolicies} ${t('metrics.activePolicies.description')}`}
        />
        <MetricCard
          title={t('metrics.conflictsDetected.title')}
          value={analytics.conflictingPolicies}
          change={-15}
          trend="down"
          icon={<AlertTriangle className="h-4 w-4 text-muted-foreground" />}
          description={t('metrics.conflictsDetected.description')}
        />
      </div>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.accessTrends.title')}</CardTitle>
                <CardDescription>{t('charts.accessTrends.description')}</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={analytics.accessTrends}>
                    ...
                    <Area 
                      ...
                      fill="#10b981" 
                      fillOpacity={0.6}
                      name={t('charts.accessTrends.granted')}
                    />
                    <Area 
                      type="monotone" 
                      dataKey="denied" 
                      ...
                      fill="#ef4444" 
                      fillOpacity={0.6}
                      name={t('charts.accessTrends.denied')}
                    />
                  </AreaChart>
                </ResponsiveContainer>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.policyDistribution.title')}</CardTitle>
                <CardDescription>{t('charts.policyDistribution.breakdown')}</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
        ...
        <TabsContent value="trends" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>{t('charts.accessTrendAnalysis.title')}</CardTitle>
              <CardDescription>{t('charts.accessTrendAnalysis.description')}</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="distribution" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.policyDistribution.title')}</CardTitle>
                <CardDescription>{t('charts.policyDistribution.distributionBreakdown')}</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
        ...
        <TabsContent value="risk" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t('charts.suspiciousPatterns.title')}</CardTitle>
              <CardDescription>{t('charts.suspiciousPatterns.description')}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
        ...
        <TabsContent value="performance" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.enforcementActivity.title')}</CardTitle>
                <CardDescription>{t('charts.enforcementActivity.description')}</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.resourceAccessVolume.title')}</CardTitle>
                <CardDescription>{t('charts.resourceAccessVolume.description')}</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
