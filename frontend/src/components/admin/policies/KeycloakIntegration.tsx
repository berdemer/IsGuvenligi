    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Synchronize roles and resources with Keycloak for centralized identity management
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div><strong>Realm:</strong> {integration.realm}</div>
              <div><strong>Client ID:</strong> {integration.clientId}</div>
              <div><strong>Mapped Roles:</strong> {integration.roles.length}</div>
              <div><strong>Mapped Resources:</strong> {integration.resources.length}</div>
            </div>
