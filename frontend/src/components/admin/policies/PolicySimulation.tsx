...
const SimulationResult: React.FC<SimulationResultProps> = ({ simulation, isLoading, t }) => {
  if (isLoading) {
    return (
      <Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="simulate" className="space-y-4">
        <TabsList>
          <TabsTrigger value="simulate">{t('tabs.simulate')}</TabsTrigger>
        ...
        <TabsContent value="simulate" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">{t('parameters.title')}</CardTitle>
                <CardDescription>{t('parameters.description')}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label>{t('parameters.selectUser')}</Label>
                  <Select value={selectedUser} onValueChange={setSelectedUser}>
                    <SelectTrigger>
                      <SelectValue placeholder={t('parameters.selectUserPlaceholder')} />
                    </SelectTrigger>
                    <SelectContent>
                      {mockUsers.map((user) => (
                ...
                <div className="space-y-2">
                  <Label>{t('parameters.selectResource')}</Label>
                  <Select value={selectedResource} onValueChange={setSelectedResource}>
                    <SelectTrigger>
                      <SelectValue placeholder={t('parameters.selectResourcePlaceholder')} />
                    </SelectTrigger>
                    <SelectContent>
          ...
          {/* Simulation Results */}
          <SimulationResult simulation={simulation} isLoading={isLoading} t={t} />
        </TabsContent>
