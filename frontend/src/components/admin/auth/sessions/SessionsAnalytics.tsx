...
export function SessionsAnalytics({ sessions, analytics }: SessionsAnalyticsProps) {
  const t = useTranslations('common.sessions.analytics')
  ...
  const riskDistribution: ChartDataPoint[] = useMemo(() => {
    const riskRanges = {
      [t('risk.lowRange')]: sessions.filter(s => (s.riskScore?.total || 0) < 40).length,
      [t('risk.mediumRange')]: sessions.filter(s => (s.riskScore?.total || 0) >= 40 && (s.riskScore?.total || 0) < 70).length,
      [t('risk.highRange')]: sessions.filter(s => (s.riskScore?.total || 0) >= 70).length
    }
  ...
  const topAnomalies = [
    { type: t('anomalies.multipleConcurrent'), count: 8, severity: "medium" },
    { type: t('anomalies.unusualLoginTime'), count: 12, severity: "low" },
    { type: t('anomalies.newDeviceLogin'), count: 5, severity: "high" },
    { type: t('anomalies.geographicAnomaly'), count: 3, severity: "high" }
  ]
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <Select value={timeRange} onValueChange={setTimeRange}>
            ...
            <SelectContent>
              <SelectItem value="1h">{t('timeRanges.lastHour')}</SelectItem>
              <SelectItem value="24h">{t('timeRanges.last24h')}</SelectItem>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-muted-foreground">{t('metrics.peakConcurrent')}</p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-muted-foreground">{t('metrics.avgDuration')}</p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-muted-foreground">{t('metrics.mfaCoverage')}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.riskDistribution')}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.topAnomalies')}</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
        ...
        <TabsContent value="geographic" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>{t('charts.sessionsByCountry')}</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.geoHeatmap')}</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-64 bg-muted rounded-lg flex items-center justify-center">
                  <div className="text-center text-muted-foreground">
                    <Globe className="h-12 w-12 mx-auto mb-4" />
                    <p className="text-lg font-medium">{t('worldMap.title')}</p>
                    <p className="text-sm">{t('worldMap.description')}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="devices" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.deviceDistribution')}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.browserDistribution')}</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {[
        ...
        <TabsContent value="security" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.securityMetrics')}</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t('security.mfaEnabled')}</span>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t('security.highRisk')}</span>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">{t('security.flagged')}</span>
                    <div className="flex items-center space-x-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle>{t('charts.securityEvents')}</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {[
